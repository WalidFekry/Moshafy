...
public class Adapterpager4 extends PagerAdapter {
    ...
    public Adapterpager4(Context context, List<item_pager> listpager5) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager5.get(position).getText1());
        tests2.setText(listpager5.get(position).getText2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager5.get(position).getText1()+"\n"+listpager5.get(position).getText2()+"\n"+ "مشاركه نصوص من تطبيق'مصحفي" +"\n"+ "\n"+" https://t.co/fkNQTMLNxn\n");
