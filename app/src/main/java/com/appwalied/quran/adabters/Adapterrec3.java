...
public class Adapterrec3 extends RecyclerView.Adapter<Adapterrec3.holder> {
    List<itemrex3> list;
    Context context;

    public Adapterrec3(List<itemrex3> list, Context context) {
        this.list = list;
    ...
    public holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itemrec3,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull holder holder, final int position) {
        ...
        holder.theader.setText(list.get(position).getTheader());
        holder.sha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,list.get(position).getTheader()+"\n"+list.get(position).getName()+"\n"+ "مشاركه نصوص من تطبيق مصحفي  \n" +"\n"+ "\n"+"https://t.co/fkNQTMLNxn");
        ...
        holder.cap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                android.content.ClipData clip = android.content.ClipData.newPlainText("",list.get(position).getTheader()+"\n"+list.get(position).getName()+"\n"+
    ...
    public class holder extends RecyclerView.ViewHolder{
        ...
        public holder(@NonNull View itemView) {
            ...
            theader=(TextView)itemView.findViewById(R.id.theader);
