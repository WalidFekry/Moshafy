...
public class Adapterpager6 extends PagerAdapter {
    ...
    int c = 18;
    Context context;
    List<item_pager> listpager6;

    public Adapterpager6(Context context, List<item_pager> listpager6) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager6.get(position).getText1());
        tests2.setText(listpager6.get(position).getText2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT, " تطبيق طريق مصحفي ");
                sendIntent.putExtra(Intent.EXTRA_TEXT, listpager6.get(position).getText1() + "\n" + listpager6.get(position).getText2() + "\n" + "مشاركه نصوص من تطبيق مصحفي" + "\n" + "\n" + " https://t.co/fkNQTMLNxn\n");
