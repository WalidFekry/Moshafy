...
public class Adapterpager3 extends PagerAdapter {
    ...
    public Adapterpager3(Context context, List<item_pager> listpager3) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager3.get(position).getText1());
        tests2.setText(listpager3.get(position).getText2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager3.get(position).getText1()+"\n"+listpager3.get(position).getText2()+"\n"+ "مشاركه نصوص من مصحفي" +"\n"+ "\n"+" https://t.co/fkNQTMLNxn\n");
