...
public class Adapterpager1 extends PagerAdapter {
    ...
    public Adapterpager1(Context context, List<item_pager> listpager1) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager1.get(position).getText1());
        tests2.setText(listpager1.get(position).getText2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, listpager1.get(position).getText1() + "\n" + listpager1.get(position).getText2() + "\n" + "مشاركه نصوص من تطبيق'مصحفي \n" + "\n" + "\n" + " https://t.co/fkNQTMLNxn\n");
